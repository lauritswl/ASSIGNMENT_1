...
### Write your code here
demograph_train <- read.csv("~/GitHub/ASSIGNMENT_1/Methods_3/demo_train.csv")
length_ut_train <- read.csv("~/GitHub/ASSIGNMENT_1/Methods_3/LU_train.csv")
word_data <- read.csv("~/GitHub/ASSIGNMENT_1/Methods_3/token_train.csv")
